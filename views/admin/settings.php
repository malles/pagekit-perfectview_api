...
<div id="perfectview_api-settings" class="uk-form uk-form-horizontal">
    ...
    <div class="uk-grid uk-grid-width-medium-1-2" data-uk-grid-margin>
        <div>
            ...
            <div class="uk-form-row">
                ...
                <div class="uk-form-controls">
                    <input id="config-api_key" type="text" name="api_key" class="uk-form-width-large"
            ...
            <div class="uk-form-row">
                ...
                <div class="uk-form-controls">
                    <input id="config-database_id" type="text" name="database_id" class="uk-form-width-large"
                           v-model="config.database_id"/>
                </div>
            </div>
            ...
            <div class="uk-form-row">
                ...
                <div class="uk-form-controls">
                    <input id="config-user_id" type="text" name="user_id" class="uk-form-width-large"
            ...
            <div class="uk-form-row">
                ...
                <div class="uk-form-controls">
                    <select name="search_types" id="config-search_types" class="uk-form-width-large"
                        ...
                        <option v-for="entityType in entityTypes | orderBy 'DescriptionSingular'"
                                :value="entityType.Id">
        ...
        <div>
            ...
            <div class="uk-form-row">
                <label for="config-person_relationship_type" class="uk-form-label">{{ 'Particulier Relationship Type' |
                    trans }}</label>
                <div class="uk-form-controls">
                    <select name="person_relationship_type" id="config-person_relationship_type"
            ...
            <div class="uk-form-row">
                <label for="config-communication_workflow" class="uk-form-label">{{ 'Communication workflow' | trans
                    }}</label>
                <div class="uk-form-controls">
                    <select name="communication_workflow" id="config-communication_workflow"
                            class="uk-form-width-medium"
            ...
            <div class="uk-form-row">
                <label for="config-communication_workflow_step" class="uk-form-label">{{ 'Communication workflowstep' |
                    trans }}</label>
                <div class="uk-form-controls">
                    <select name="communication_workflow_step" id="config-communication_workflow_step"
                            class="uk-form-width-medium"
